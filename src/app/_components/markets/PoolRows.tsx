...
const PoolRows = ({asset , colleteralT , borrowingT , lendingT , cAPR , lAPR , bAPR} : IRows) => {
  ...
  >
    ...
    <button className={`rounded-lg bg-accent text-black py-1.5 px-3`}>Supply</button>
    <button className={`rounded-lg border text-white/50 border-white/50 py-1.5 px-3`}>Borrow</button>
    </div>
